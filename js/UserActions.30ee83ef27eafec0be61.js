  ...
  2913: function (t, a) {
    ...
    const e = (t, a, e) => {
      const n = {
        ...
        warning: {border: "yellow-mid", color: "charcoal", bg: "yellow-xlight"},
        info: {border: "blue-light", color: "charcoal", bg: "blue-xlight"},
        success: {border: "green-mid", color: "charcoal", bg: "green-xlight"}
    ...
    var n = e(3443), l = e(4114), s = e(6596);
    ...
    "use strict";
    var n = e(8774), l = e(6596), s = e(8858), i = e(681);
    const c = [{key: "private", label: l.s.csr.lists.privacy.private(), value: 0}, {
      key: "unlisted",
      label: l.s.csr.lists.privacy.unlisted(),
      value: 1
    }, {key: "public", label: l.s.csr.lists.privacy.public(), value: 2}], o = t => 2 === t ? {
    ...
    var n = e(9894), l = e(5982), s = e(3443),
      ...
      c = e(7078), o = e.n(c), r = e(8785);
    const d = () => (0, n.y0)().saved, u = t => (0, n.IW)({saved: {...d(), ...t}});
    ...
    var m = t => {
      switch (t.name) {
        case"click:BOOKMARK_ADD": {
          ...
          const a = parseInt(t.detail.id, 10), e = t.detail.type, s = d();
        ...
        case"click:BOOKMARK_REMOVE": {
          if (t.target.disabled) return;
          const a = parseInt(t.detail.id, 10), e = t.detail.type, l = d();
          (0, r.Z)("SAVED/REMOVE", {
            parameters: {
              ...t.detail,
              count: t.detail.count ? t.detail.count - 1 : null
    ...
    var n = e(9894), l = e(5982), s = e(3443), i = e(8785), c = t => {
      switch (t.name) {
        case"click:FOLLOW":
        case"click:UNFOLLOW": {
          const a = parseInt(t.detail.id, 10), e = parseInt(t.detail.count, 10) + (t.name.match(/UNFOLLOW/) ? -1 : 1),
            c = t.detail.hideCountOnFollowed || !1, o = t.detail.cmptId || !1;
          if (!(0, n.y0)().user.loggedIn) return void (0, l.W)("signup", "SIGNUP_INTENT", {
            returnToPage: !0,
            source: "follow"
          });
        ...
        case"mouseenter:FOLLOW_ROW": {
          const a = t.target.querySelector("[data-offset-src]"), e = a.offsetLeft;
    ...
    "use strict";
    e.r(a);
    var n = e(9894), l = e(5982), s = e(5167), i = e(1029), c = e(4114), o = e(2913), r = e(7078), d = e.n(r),
      u = e(6259), m = e.n(u), p = e(3443), g = e(8785), v = e(5799), b = e(5414);
    const h = () => (0, n.y0)().lists, y = t => (0, n.IW)({lists: {...h(), ...t}});
    y({
      ...
      switch (t.name) {
        ...
        case"change:LISTS_TITLE":
          y({form: {...h().form, titleValue: t.originalEvent.target.value}});
          break;
        case"change:RADIO":
        ...
        case"submit:LIST_CREATE": {
          ...
          const a = new FormData(t.target),
            e = {courseId: t.detail.id, name: a.get("listName"), privacy: Number(a.get("privacy"))}, l = h();
          l.addToList = l.addToList || {}, l.addToList.status = "processing", y(l), (0, n.sY)("modal-add-to-list", (0, s.Z)((0, n.y0)())), (0, g.Z)("LISTS/CREATE", {data: e});
          break
        }
        ...
        case"request:LIST/REMOVE_ERROR": {
          const e = h().savingItems, {listId: i, type: c, id: o} = t.detail.originalParameters;
          if (d()(e, (t => t === i)), t.detail.json.success) y({
            saving: !1,
            savingItems: e,
            notification: {message: t.name.match(/SUCCESS/) ? "Saved" : "An error occurred. Please try again."}
          }); else {
            var a;
            const n = h().available.slice(), s = m()(n, (t => parseInt(t.id, 10) === parseInt(i, 10)));
        ...
        case"request:LISTS/CREATE_SUCCESS": {
          ...
          }, a.form = {titleValue: null, privacyValue: 0}, y(a), (0, n.sY)("modal-add-to-list", (0, s.Z)((0, n.y0)()));
          break
        }
    ...
    "use strict";
    e.r(a);
    var n = e(9894), l = e(3443);
    (0, n.IW)({modal: {}}), a.default = t => {
    ...
    "use strict";
    e.r(a);
    var n = e(5982), l = e(8785), s = e(1029), i = e(9894), c = e(3443);
    a.default = t => {
      switch (t.name) {
    ...
    "use strict";
    e.r(a);
    var n = e(3499), l = e(9894), s = e(3443);
    const i = {month: null, year: null}, c = (t, a) => {
      t.querySelector('input[name="'.concat(a, '"]')).dispatchEvent(new window.Event("input"))
    };
    a.default = t => {
      switch (t.name) {
        case"click:DOCUMENT": {
          if ((0, s.IY)({event: t.originalEvent, cushion: 0, container: ".cmpt-select-date-overlay"})) return;
          ...
          a.length && [].slice.call(a).forEach((t => {
            if (t.querySelector(".cmpt-select-date-overlay")) {
              ...
              (0, l.sY)("date-select-".concat(a.name, "-").concat(a.id), (0, n.Z)({...a, ...i, isActive: !1}), (t => {
                c(t, a.name)
              }))
            }
          }));
        ...
        case"mousedown:CLEAR_YEAR": {
          const a = t.target.closest(".cmpt-select-date").querySelector(".cmpt-select-date-year .overflow-y").scrollTop, [e, s] = t.name.split(":")[1].toLowerCase().split("_");
          i[s] = "clear" === e ? "" : t.detail[s], (0, l.sY)("date-select-".concat(t.detail.name, "-").concat(t.detail.id), (0, n.Z)({...t.detail, ...i}), (t => {
        ...
        case"blur:SELECT_DATE_INPUT_YEAR":
          (0, l.sY)("date-select-".concat(t.detail.name, "-").concat(t.detail.id), (0, n.Z)({...t.detail, ...i}));
          break;
        ...
        case"blur:SELECT_DATE_INPUT_MONTH":
          (0, l.sY)("date-select-".concat(t.detail.name, "-").concat(t.detail.id), (0, n.Z)({...t.detail, ...i}), (t => {
            if (i.month) {
    ...
    var n = e(9894), l = () => {
      ...
      switch (t.name) {
        case"click:SOCIAL_INIT": {
          ...
          if (navigator.share) return void navigator.share({title: document.title, url: t}).then((() => {
          })).catch((() => {
          }));
          (0, n.sY)("modal", (0, s.Z)({content: l(), style: {width: 300, height: 315}}), null, !0);
          break
        }
        case"click:COPY":
    ...
    "use strict";
    e.r(a);
    var n = e(7078), l = e.n(n), s = e(6259), i = e.n(s), c = e(9894), o = e(5167), r = e(8785), d = e(5799);
    a.default = t => {
      const a = parseInt(t.detail.id, 10), e = t.detail.type, n = t.detail.listId,
        s = (0, c.y0)().lists.available.slice(), u = (0, c.y0)().lists.savingItems,
    ...
    "use strict";
    e.r(a);
    var n = e(1054), l = e(2993), s = e(9627), i = e(2867), c = e(6491), o = e(8708), r = e(4180), d = e(4581);
    a.default = t => {
    ...
    t.exports = function (t, a, e, n) {
      for (var l = t.length, s = e + (n ? 1 : -1); n ? s-- : ++s < l;) if (a(t[s], s, t)) return s;
      return -1
    }
  }, 4146: function (t, a, e) {
    var n = e(830), l = e(2383), s = Array.prototype.splice;
    ...
    var n = e(6747), l = e(1159), s = e(4373), i = e(7948);
    t.exports = function (t, a) {
      return a = n(a, t), null == (t = s(t, a)) || delete t[i(l(a))]
    }
  }, 4373: function (t, a, e) {
    var n = e(9867), l = e(5733);
    t.exports = function (t, a) {
      return a.length < 2 ? t : n(t, l(a, 0, -1))
    }
  }, 6259: function (t, a, e) {
    var n = e(5372), l = e(9278), s = e(7991), i = Math.max;
    t.exports = function (t, a, e) {
    ...
    var n = e(9278), l = e(4146);
    t.exports = function (t, a) {
      var e = [];
      if (!t || !t.length) return e;
      var s = -1, i = [], c = t.length;
      for (a = n(a, 3); ++s < c;) {
        var o = t[s];
